...
export const equations: Equation[] = [
  {
    id: "alien-worm",
    title: "Alien Worm",
    description: "A mesmerizing parametric equation creating organic, worm-like patterns",
    ...
    sketch: (p: any) => {
      ...
      function plotAlienWorm() {
        for (let i = 0; i < 10000; i++) {
          const x = i
          const y = i / 235
          const d = p.mag((4 + p.sin(y * 2 - t) * 3) * p.cos(x / 29), y / 8 - 13)
          const k = (4 + p.sin(y * 2 - t) * 3) * p.cos(x / 29)
          const e = y / 8 - 13
          const q = 3 * p.sin(k * 2) + 0.3 / k + p.sin(y / 25) * k * (9 + 4 * p.sin(e * 9 - d * 3 + t * 2))
          const c = d - t
  ...
  },
  {
    ...
    description: "Visualization of wave interference patterns creating beautiful ripples",
  ...
  },
  {
    ...
    description: "The famous butterfly effect visualized through chaotic dynamics",
